...
function nimbus_field_engine() {
    ...
    foreach ($options as $option) {
        ...
        if ($option['type'] == "text") {
            ...
            $section_return[$option['tab']] .= '<p><span style="color:#fc7e2a;">This feature is available to Nimbus Themes members.</span> <a href="' . SALESPAGEURL . '?utm_source=simple&utm_medium=theme&utm_content=panel_link&utm_campaign=simple">Join today!!</a></p>';
            $field_num++;    
