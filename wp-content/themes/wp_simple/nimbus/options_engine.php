...
function nimbus_field_engine() {
    ...
    foreach ($options as $option) {
        ...
        if ($option['type'] == "text") {
            ...
            $section_return[$option['tab']] .= '<p><span style="color:#fc7e2a;">This feature is availible to Nimbus Themes members.</span> <a href="http://www.nimbusthemes.com/?utm_source=wp_opulus&utm_medium=theme&utm_content=panel_link&utm_campaign=opulus">Join today!!</a></p>';
            $field_num++;    
